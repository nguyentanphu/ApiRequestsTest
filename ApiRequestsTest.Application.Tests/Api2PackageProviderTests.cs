...
public class Api2PackageProviderTests
{
    ...
    public void GetAuthenticationCredential_Succeed()
    {
        ...
        _factoryMock.Setup(f => f.CreateClient(nameof(Api2PackageProvider)))
            .Returns(httpClient);

        var subject = new Api2PackageProvider(_configuration, _factoryMock.Object);
    ...
    public void SerializeInput_Succeed()
    {
        ...
        Assert.Equal(
            "{\"Consignor\":\"123\",\"Consignee\":\"456\",\"Cartons\":[{\"Width\":22,\"Length\":33,\"Height\":44}]}",
            result);
    }
